...
public class Play_Fair_Cipher_Substitution {
    ...
    private void KeyGen() {
        ...
        for (int i = 0; i < 26; i++) {
            ...
            if (flag)
                Key = String.format("%s%s", Key, current);
            flag = true;
        }
    ...
    private String encryptMessage(String Source) {
        ...
        for (String s : src_arr) {
            ...
            Code = new StringBuilder().append(Code).append(matrix_arr[part1[0]][part1[1]]).append(matrix_arr[part2[0]][part2[1]]).toString();
        }
        return Code;
    }
}
